; ModuleID = 'swap_problem.c'
source_filename = "swap_problem.c"
...
define noundef i32 @main() local_unnamed_addr #0 {
  ...
  %4 = call i32 (ptr, ...) @scanf(ptr noundef nonnull @.str.2, ptr noundef nonnull %3)
  %5 = load i64, ptr %3, align 8, !tbaa !5
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %3) #4
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %2) #4
  store i64 0, ptr %2, align 8, !tbaa !5
  %6 = call i32 (ptr, ...) @scanf(ptr noundef nonnull @.str.2, ptr noundef nonnull %2)
  %7 = load i64, ptr %2, align 8, !tbaa !5
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %2) #4
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %1) #4
  store i64 0, ptr %1, align 8, !tbaa !5
  %8 = call i32 (ptr, ...) @scanf(ptr noundef nonnull @.str.2, ptr noundef nonnull %1)
...
22:                                               ; preds = %20, %22
  %23 = phi i64 [ %24, %22 ], [ %7, %20 ]
  %24 = phi i64 [ %23, %22 ], [ %5, %20 ]
  %25 = phi i64 [ %26, %22 ], [ 0, %20 ]
  %26 = add i64 %25, 1
  %27 = icmp eq i64 %26, %12
  br i1 %27, label %28, label %22, !llvm.loop !11

28:                                               ; preds = %22, %20
  %29 = phi i64 [ %5, %20 ], [ %23, %22 ]
  %30 = phi i64 [ %7, %20 ], [ %24, %22 ]
  %31 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i64 noundef %30)
  %32 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i64 noundef %29)
  ret i32 0
}
